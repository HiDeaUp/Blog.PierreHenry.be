+++
title = "How to Find Motivation When You Feel Drained Without Waiting for It"
slug = "how-to-find-motivation-when-you-feel-drained-without-waiting-for-it"
date = "2025-05-29T20:22:26.385168"
draft = false
description = "Sometimes, motivation just isn’t there. You want to do something, but you feel drained, like your battery is dead. That’s when you need to find ways to recharge your energy. It’s not about waiting..."
summary = "Sometimes, motivation just isn’t there. You want to do something, but you feel drained, like your battery is dead. That’s when you need to find ways to recharge your energy. It’s not about waiting..."
tags = ["energize", "motivation", "personal development", "resilience", "self-help", "tasks"]
priority = true
priority_topics = ["tasks"]
original_title = "RETROUVER LA MOTIVATION – DES CLÉS SIMPLES POUR TE RELEVER QUAND TOUT SEMBLE LOURD"
source_medium = "https://medium.com/@phenrysay/c7e4bba672d6"
+++
...
- Do quick physical exercises to shake off heaviness.
- Reward yourself after completing tasks.
- Simplify the start of your work to reduce friction.
- Create a pleasant environment to motivate yourself.

---

## Action Steps

- Go to a different place when feeling unmotivated.
- Listen to energizing music with headphones.
- Jump or stretch before starting work.
- Set small milestones with rewards.
- Make your workspace inviting or change locations.
- Book a nice place to work if possible.
