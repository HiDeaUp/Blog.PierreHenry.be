...
{{< figure src="https://images.unsplash.com/photo-1681928412599-8e7533ee5ef1?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w2NjcyMjF8MHwxfHNlYXJjaHwyfHxDaGF0R1BUJTIwTUNQJTIwY29kZWJhc2UlMjBpbnRlZ3JhdGlvbnxlbnwwfDB8fHwxNzY3MDc5MDg0fDA&ixlib=rb-4.1.0&q=80&w=1080" alt="Computer keyboard with the word HTC on it" title="How to Code in MCP Using ChatGPT Without Leaving VS Code" caption="How to Code in MCP Using ChatGPT Without Leaving VS Code - Photo by [Rubaitul Azad](https://unsplash.com/@rubaitulazad) on [Unsplash](https://unsplash.com/photos/a-computer-keyboard-with-the-word-htc-on-it-UQT2ZpYiOP8)" >}}
...
- The “work with code” extension for ChatGPT opens a whole new workflow for developers.
