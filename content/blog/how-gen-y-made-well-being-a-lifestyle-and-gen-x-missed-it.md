+++
title = "How Gen Y Made Well-Being a Lifestyle (and Gen X Missed It)"
slug = "how-gen-y-made-well-being-a-lifestyle-and-gen-x-missed-it"
date = "2025-08-19T14:20:32.461851"
draft = false
description = "When we look at the differences between Generation X and Generation Y, one thing stands out: their approach to wellbeing. Gen X, now mostly between 55 and 75 years old, grew up with a different ide..."
summary = "When we look at the differences between Generation X and Generation Y, one thing stands out: their approach to wellbeing. Gen X, now mostly between 55 and 75 years old, grew up with a different ide..."
tags = ["generation x", "generation y", "generational differences", "lifestyle habits", "nomad", "productivity", "well-being"]
priority = true
priority_topics = ["nomad", "productivity"]
original_title = "Choc générationnel : Pourquoi la Gen Y est obsédée par le bien-être (et ce que la Gen X n'a jamai..."
...
- Gen Y puts well-being and comfort at the center of life, while Gen X focused more on achievement and routine.
- Meditation, yoga, and "hygge" are now mainstream, but older generations may find it hard to adopt new habits.
- Travel, shopping, and social life have all become more accessible and influenced by technology.
- The pressure to fit in—online and offline—can lead to overconsumption and stress.
- Both generations have things to learn from each other about happiness and balance.
...
*Are your habits helping you feel happier, or just busier?*
*What small change could you make today to enjoy life a little more?*
