+++
title = "How to Say No Without Feeling Guilty and Put Yourself First"
slug = "how-to-say-no-without-feeling-guilty-and-put-yourself-first"
date = "2025-08-30T14:12:47.607375"
draft = false
description = "We all have moments when we need to leave, to move on, to focus on what truly matters. Picture this: you’re ready to go out, coat on, headphones in, prepared for your next step. But then, someone s..."
summary = "We all have moments when we need to leave, to move on, to focus on what truly matters. Picture this: you’re ready to go out, coat on, headphones in, prepared for your next step. But then, someone s..."
tags = ["mental health", "personal growth", "priorities", "productivity", "self-care", "setting boundaries", "time management"]
priority = true
priority_topics = ["time management", "productivity"]
original_title = "Quelles sont tes priorités ? 💭"
...
- Know what’s important and urgent for you.
- Don’t always say yes just to please others.
- Taking care of your own priorities helps you be better with others.
