...
slug = "how-to-change-your-perspective-without-changing-your-life"
date = "2025-08-17T18:58:18.024334"
draft = false
description = "Have you ever noticed how two people can look at the same situation and react in completely different ways? It’s almost as if we’re all wearing different glasses, each tinted by our upbringing, our..."
summary = "Have you ever noticed how two people can look at the same situation and react in completely different ways? It’s almost as if we’re all wearing different glasses, each tinted by our upbringing, our..."
tags = ["entrepreneurship", "mindset shift", "overcoming limitations", "personal growth", "perspective", "productivity", "self-improvement", "tasks", "tech"]
priority = true
priority_topics = ["tech", "tasks", "productivity", "entrepreneurship"]
original_title = "Changer le mindset qui tire vers le bas. Cela peut tout changer pour toi"
source_medium = "https://medium.com/@phenrysay/7361942c3c1d"
+++
...
Our reactions to events are influenced by our values, which are never exactly the same from one person to another. What shocks one person might not even make another blink. Something that feels like the end of the world to you could be just a minor annoyance to someone else. And the opposite is true, too.
...
## Key Takeaways
- The way you see things is influenced by your past, your values, and your personality.
