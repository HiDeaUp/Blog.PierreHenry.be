+++
title = "How to Move Forward by Pressing Pause on Your Life"
slug = "how-to-move-forward-by-pressing-pause-on-your-life"
date = "2025-08-19T23:22:41.401707"
draft = false
description = "Building your life and achieving things for yourself is what makes all the difference. Action is essential. If you never act, if you are not proactive in your decisions, or if you do not even know..."
summary = "Building your life and achieving things for yourself is what makes all the difference. Action is essential. If you never act, if you are not proactive in your decisions, or if you do not even know..."
tags = ["goal-setting", "life-rebuilding", "money", "motivation", "personal-growth", "productivity", "self-improvement", "tasks", "tech"]
priority = true
priority_topics = ["tech", "money", "tasks", "productivity"]
original_title = "Comment (re)construire sa vie ? 🗺️"
...
One of my favorite ways to do this is to sit in a café for an hour, just thinking and brainstorming. I ask myself: by next week, what will I have accomplished? Often, what I end up wanting is completely different from what I thought at first. We are easily influenced by others, but deep down, our real desires can be very different.

For example, I once thought I absolutely needed a master’s degree in data science. I believed it would give me recognition and a better title. Sure, for immigration, it is easier to move to countries like Japan, Korea, Canada, or New Zealand with a master’s degree. But then I realized I did not even want to work as a data scientist in a company. So, what was the point? If you want to be a freelancer, the experience matters much more than the degree. The truth is, what you learn in a master’s is not always that much, and it is the hands-on experience that counts.
...
When I do this, people around me sometimes make fun of me. My girlfriend, my family, even my mother. But it is important to take a week off, think about your life, and then come back with more energy and a clearer direction. Life is too short to make choices that do not excite you. You need to make the right decisions as soon as possible, and taking breaks is what makes all the difference.

If you want to move forward, you have to act. There is a famous Chinese proverb:
